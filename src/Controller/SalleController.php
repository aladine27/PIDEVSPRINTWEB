...
class SalleController extends AbstractController
{
    ...
    #[Route('/{nbre_salle}', name: 'app_salle_show', methods: ['GET'])]
    ...
    #[Route('/{nbre_salle}/edit', name: 'app_salle_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/{nbre_salle}', name: 'app_salle_delete', methods: ['POST'])]
    public function delete(Request $request, Salle $salle, SalleRepository $salleRepository): Response
    {
        if ($this->isCsrfTokenValid('delete'.$salle->getNbreSalle(), $request->request->get('_token'))) {
